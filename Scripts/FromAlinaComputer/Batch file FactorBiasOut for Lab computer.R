...
C:/TNC_Connectivity_AlinaVania/ASC/Dry
...
outputtxt_Dry <- "C:/Users/alina/Documents/git/TNC_Kenya_Connectivity/Input/MaxentTemp/BatchFiles/FactorBiasOut/LabComputer/Dry/" # Where to keep the text files containing the java codes
