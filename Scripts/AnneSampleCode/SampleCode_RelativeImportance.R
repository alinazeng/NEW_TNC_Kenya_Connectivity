...
names(mxtresults) <-  c( "Species" ,  "Trnsamples",   "Regtraining_gain", "UnRegtraininggain" ,   "Iterations", "TrainingAUC" , "TestSamples",  "Test.gain" ,  "Test_AUC" ,  "AUCsd" , "Background_pnts" ,"dHwRailw", "Elev" ,"agbiomass",  "bio10"  ,"bio11" , "bio15"  ,  "bio16",  "bio17", "dhi_ggp_min","drivermainstem"    , "drivertrib" , "dwetlands"  ,"pcrops"   , "pdecclosed"   , "pdecopen"    , "pgrasslands"  ,  "pshrublands"    , "density_pathRoads" ,  "Prevalence",  "EqualtrainingsensitivityandspecificitylogisticTrd" )
